...
# from app.rag.repository.ingestion_repository import get_embeddings_by_document_id,insert_embeddings
...
def ingest_document(document_id: UUID):
    ...
    if not embedded_data:
        ...
        if(embed_response): mark_document_embedded(document_id)
